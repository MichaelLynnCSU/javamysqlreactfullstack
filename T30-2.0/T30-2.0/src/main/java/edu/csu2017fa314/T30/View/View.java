...
static double[]  degree2SVG (double latitude, double longitude) {
   	...
   	public static void buildMap(String[][] itinerary) {
		  try{
   ...
   public void buildJSON(String[][] itinerary, ArrayList<TreeMap<String,String>> jsonData, ArrayList<String> myKeys) {
...
//      System.out.println(jsonData.get(0).get(myKeys.get(2)));
      ...
      for (int i = 0; i < itinerary.length; i++) {
         ...
         try (FileWriter file = new FileWriter("web/test.json")) {
